 ...
 ****************************************************************************/
 queue <patient* > mainPatientList;
 Icu IcuList[N_ICU];
 doctor doctorsList[N_DOCTORS];
/*************************************************************************
 *                              DEFINITIONS
 * **********************************************************************/
 /*****************************************************************************
                               DOCTORS' functions DEFINITIONS
  ****************************************************************************/
doctor::doctor()
{
     /* identifier that this doctor's seat exist but the doctor doesn't exist */
     this-> name = "null";
}
/*****************************************************************************
                              ICUs functions DEFINITIONS
 ****************************************************************************/
Icu::Icu()
{
  this->name = "null";
...
void addNewDoctor_function(doctor* list)
{
  ...
  int i = 0;
  /* searching for the first null seat that can be filled */
  while(list[i].name != "null")
  {
    i++;
  }
  /* filling the name , gender , birthdate , socialSecurityNumber , majorScientificArea and degree */
  cout << "enter doctor's name: ";
  cin >> list[i].name;
  cout << "enter doctor's gender: ";
  cin >> list[i].gender;
  cout << "enter doctor's birth date: ";
  cin >> list[i].birthDate;
  cout << "enter doctor's social security number: ";
  cin >> list[i].socialSecurityNumber;
  cout << "enter doctor's major scientific area: ";
  cin >> list[i].majorScientificArea;
